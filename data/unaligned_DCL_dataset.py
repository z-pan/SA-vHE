# Defines the dataset class for dual contrastive learning (DCL) using unaligned images.
...
class UnalignedDCLDataset(BaseDataset):
    """
    ...
    def __getitem__(self, index):
        ...
        A_img = Image.open(A_path).convert('RGB') # DCL model
        B_img = Image.open(B_path).convert('RGB') # DCL model
        
        # read images as np.float32
        # option#1: for .png, using PIL
        ...
        # option#2: for .tiff, using libtiff
